...
parser.add_argument('--result_name', default="from_scratch")
...
def main(model):
    ...
    train(model, criterion, optimizer, dataTrain, dataVal)


def train(model, criterion, optimizer, dataTrain, dataVal):
