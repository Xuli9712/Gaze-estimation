...
if __name__ == '__main__':
    dataset_path = r'F:\brl4200'
    meta_file = r'F:\brl4200\brl4200_person_specific.json'
    onlyRawImage=False
    train_dataset = BRL4200GazeData(dataset_path, split='train',right_eye_flip=True, face_size=(224,224), eye_size=(112, 112), grid_size=(25,25), landmark_mask=False, meta_file=meta_file, onlyRawImage=False)
    print(len(train_dataset))
    if onlyRawImage == False:
        Img, Face, LEye, REye, Grid, GazePointCM, GazePointPixel = train_dataset[10]
        print(Face.shape)
        print(LEye.shape)
        print(Grid.shape)
        print(GazePointCM)
