...
parser.add_argument('--meta_file', default=r'C:\Users\Xuli\Desktop\MPIIGazeCode\all_data_with_eye.json')    # use meta with dotcam and ori
parser.add_argument('--model', default='ITrackerOriAffine')
parser.add_argument('--pretrained_path', default=r'weights\ITracker_use_ori_grid_flip.pth')   #'weights\ITracker_use_ori_grid_flip.pth'
parser.add_argument('--epochs', default=30)
parser.add_argument('--batch_size', default=32)
parser.add_argument('--num_workers', default=8)
parser.add_argument('--save_per_epoch', default=1)
parser.add_argument('--result_name', default="affine3")
...
def train(model, dataTrain, dataVal):
    ...
    # 只对affine_layer进行优化
    optimizer = torch.optim.Adam(model.module.affine_layer.parameters(), lr,
                                weight_decay=weight_decay)
    
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer=optimizer, milestones=lr_decay_milestones,gamma=lr_decay_gamma)
